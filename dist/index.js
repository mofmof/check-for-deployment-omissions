...
const getCompareCommitsSize = (owner, repo, basehead) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { data } = yield octokit.repos.compareCommitsWithBasehead({
        owner,
        repo,
        basehead
    });
...
const getLatestDeploymentCommit = (owner, repo) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const latestDeploymentCommit = (_a = result.repository.deployments.nodes.find(node => node.state === 'ACTIVE')) === null || _a === void 0 ? void 0 : _a.commit.oid;
    return latestDeploymentCommit;
});
exports.getLatestDeploymentCommit = getLatestDeploymentCommit;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const slackResponse = yield web.chat.postMessage({
                text: `${owner}/${repo} に未デプロイの変更${len > 0 ? `があります (${len}commits)` : 'はありません'}`,
